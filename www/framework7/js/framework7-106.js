        ...
        ************   Modals   ************
        ...
        app.showPreloader = function (title) {
            return app.modal({
                ...
                text: '<div class="preloader"><svg xmlns="http://www.w3.org/2000/svg" height="75" width="75" viewBox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"></circle></svg></div>',
        ...
        app.showIndicator = function () {
            $('body').append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preloader preloader-white"><svg xmlns="http://www.w3.org/2000/svg" height="75" width="75" viewBox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"></circle></svg></span></div>');
        };
        ...
        ************   Photo Browser   ************
        ...
        var PhotoBrowser = function (params) {
            ...
            var photoTemplate = !pb.params.lazyLoading ? 
                ...
                (pb.params.photoLazyTemplate || '<div class="photo-browser-slide photo-browser-slide-lazy swiper-slide"><div class="preloader' + (pb.params.theme === 'dark' ? ' preloader-white' : '') + '"><svg xmlns="http://www.w3.org/2000/svg" height="75" width="75" viewBox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"></circle></svg></div><span class="photo-browser-zoom-container"><img data-src="{{url}}" class="swiper-lazy"></span></div>');
            ...
            pb.open = function (index) {
                ...
                if (pb.params.type === 'popup') {
                    pb.popup = app.popup('<div class="popup photo-browser-popup tablet-fullscreen">' + htmlTemplate + '</div>');
